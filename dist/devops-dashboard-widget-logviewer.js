...
angular.module('DevopsDashboard.widget.logviewer', ['adf.provider'])
  ...
  .controller('logDataCtrl', ["$scope", "$timeout", "User", "DBLogger", function($scope, $timeout, User, DBLogger) {
